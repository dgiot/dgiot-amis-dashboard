 ...
 */
export async function getEvidence(ObjectId:String) {
 ...
 * @return {Promise<*|ElMessageComponent>}
 */
export async function delEvidence(ObjectId:String) {
...
/**
 * @doc-api http://121.5.171.21/dgiot_swagger/#/Evidence/post_generatereport
 * @param params
 * @return {Promise<*|ElMessageComponent>}
 */
...
/**
 * @doc-api http://121.5.171.21/dgiot_swagger/#/Evidence/post_drawxnqx
 * @param params
 * @return {Promise<*|ElMessageComponent>}
 * @description 生成性能曲线图
 */
