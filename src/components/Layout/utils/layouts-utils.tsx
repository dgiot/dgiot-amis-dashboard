...
const getPageType = (runtimeRouter: RuntimeRouter): TabPageType => {
    ...
    if (
        pagePath.endsWith('.schema.tsx') ||
        pagePath.endsWith('.schema.ts') ||
        pagePath.endsWith('.schema.js') ||
        pagePath.endsWith('.schema.jsx')
    ) {
        return 'amis';
    }
    if (
        pagePath.endsWith('.react.tsx') ||
        pagePath.endsWith('.react.ts') ||
        pagePath.endsWith('.react.js') ||
        pagePath.endsWith('.react.jsx')
    ) {
        return 'react';
    }
    return 'iframe';
