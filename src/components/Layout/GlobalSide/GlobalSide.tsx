    ...
    public render() {
        ...
        return (
            <>
                ...
                {/* 中间菜单区域 */}
                {getCenterNode<GlobalSideProps>(this.props, styles.globalCentre, (elementMap) =>
                    elementMap.set('firstMenu', this.getFirstMenu())
                )}
                {/* 底部区域 */}
