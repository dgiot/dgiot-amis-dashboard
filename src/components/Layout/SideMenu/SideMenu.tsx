...
class SideMenu extends React.Component<SideMenuProps, SideMenuState> {
    ...
    public render() {
        ...
        return (
            <>
                {/* 顶部区域 */}
                {getTopNode<SideMenuProps>(this.props, styles.sideMenuTop, (elementMap) =>
                    elementMap.set('inputSearch', this.getInputSearch())
                )}
                {/* 中间菜单区域 */}
                {getCenterNode<SideMenuProps>(this.props, styles.sideMenuCentre, (elementMap) =>
                    elementMap.set('secondMenu', this.getSecondMenu())
                )}
                {/* 底部区域 */}
